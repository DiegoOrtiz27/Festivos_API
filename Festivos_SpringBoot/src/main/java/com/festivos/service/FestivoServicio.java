...
import com.festivos.interfaces.FestivoInterface;
import com.festivos.model.Festivo;
import com.festivos.model.FestivoOperaciones;
import com.festivos.repository.FestivoRepositorio;

@Service
public class FestivoServicio implements FestivoInterface{
    ...
    public List<FestivoOperaciones> obtenerFestivos(int año) {
        ...
        List<FestivoOperaciones> fechas = new ArrayList<FestivoOperaciones>();
        for (final Festivo festivo : festivos) {
            fechas.add(new FestivoOperaciones(festivo.getNombre(), festivo.getFecha()));
        }
        return fechas;
    }
